...
"""
        ...
        prompt = f"""
你是一名保险政策研究人员，请依据以下参考资料撰写一份逻辑清晰、书面化的回答。
若资料不足以得出明确结论，请说明：“参考资料不足以支撑明确结论”。
...
3. Keep your response formal, concise, and professional.
...
"""
        ...
        prompt = f"""
You are a researcher specializing in insurance policies. Please write a formal, logically structured answer based on the reference materials.
If the materials are insufficient to reach a conclusion, state:
"The available materials are insufficient to draw a clear conclusion."
